...
var healthCareAdvocate = angular.module('healthCareAdvocate', [
  'ui.router',
  'ui.bootstrap',
  "snap", 
  "ngAnimate",
...
//Config phase
healthCareAdvocate.config(function($urlRouterProvider, $httpProvider) {
...
//Run phase
healthCareAdvocate.run(function($rootScope, $state) {
...
//Datatable
healthCareAdvocate.factory('dataTable', ['$filter', 'ngTableParams', function($filter, ngTableParams) {
