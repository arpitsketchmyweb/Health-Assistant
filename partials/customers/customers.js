...
//Factories
healthCareAdvocate.factory('customerServices', ['$http', function($http) {
...
//Controllers
healthCareAdvocate.controller('getCustomersController', ['$scope', 'customerServices', 'dataTable', function($scope, customerServices, dataTable) {
...
healthCareAdvocate.controller('addCustomerController', ['$scope', 'customerServices', '$location', function($scope, customerServices, $location) {
...
healthCareAdvocate.controller('viewCustomerController', ['$scope', 'customerResolved', function($scope, customerResolved) {
	$scope.viewCustomer = customerResolved.data;
}]);

healthCareAdvocate.controller('editCustomerController', ['$scope', 'customerResolved', 'customerServices', '$location', '$state', function($scope, customerResolved, customerServices, $location, $state) {
